...
// // This is the individual card for a testimonial. No changes are needed here.
...
//     // We MUST duplicate the testimonials to create a seamless, infinite loop.
//     const scrollingTestimonials = [...testimonials, ...testimonials];

//     return (
//         <section id="testimonials" className="py-20 relative bg-slate-50 font-sans">
//             {/* The CSS for the scrolling animation is defined here */}
//             <style>
//                 {`
//                     @keyframes scroll {
...
//                         /* Pauses animation on hover for better user experience */
//                         &:hover {
...
//                   - It has a fixed height (h-[600px]).
//                   - overflow-hidden clips the content outside this box.
//                   - The mask-image with a custom linear-gradient creates the fade effect.
//                     - The gradient is transparent at the top and bottom.
//                     - It quickly fades to black (opaque) in the middle, creating a "focus window"
//                       that makes the central card sharp and the ones above/below appear faded.
//                 */}
//                 <div 
...
//                 >
//                     <div className="absolute animate-scroll" style={{ animationDuration: '60s' }}>
...
// // Main App component to display the testimonials section
...
// Main Testimonials section component
export const Testimonials = () => {
    // --- NEW: State to manage the animation pause on touch devices ---
        ...
        <section id="testimonials" className="py-20 relative bg-slate-50 font-sans">
            <style>
                {`
                    ...
                    /* This CSS rule handles pausing on DESKTOP when a user hovers over the list */
            ...
            <div className="container z-10 mx-auto px-4">
                <div className="flex flex-col items-center justify-center max-w-2xl mx-auto text-center">
                    ...
                    <p className="mt-5 text-lg text-slate-900 font-medium">
                        See what our customers have to say about us.
                    </p>
                </div>
                ...
                <div 
                  ...
                  style={{ maskImage: 'linear-gradient(to bottom, transparent, black 25%, black 75%, transparent)' }}
                >
                    {/* --- MODIFIED: Added touch events and dynamic styles --- */}
                    <div 
                        className="absolute animate-scroll" 
                        // These event handlers are for touch screens (mobile)
                        onTouchStart={() => setIsPaused(true)}
                        onTouchEnd={() => setIsPaused(false)}
                        style={{ 
                            animationDuration: '60s',
                            // This style dynamically pauses the animation based on the 'isPaused' state
