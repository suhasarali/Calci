    ...
    return (
        <section className="w-full  py-5 sm:py-12">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mt-16 grid grid-cols-1 gap-2 lg:grid-cols-6">
                    {/* Card 1: 100% Customizable */}
                    <BentoItem className="lg:col-span-2 flex flex-col items-center justify-center">
                        <div className="relative flex h-24 w-56 items-center text-gray-300">
                            ...
                            <span className="mx-auto block w-fit text-2xl font-semibold text-blue-950">100% Free Tools</span>
                        </div>
                    ...
                    <BentoItem className="lg:col-span-2">
                        ...
                        <div className="relative z-10 mt-6 space-y-2 text-center">
                            ...
                            <p className="text-gray-600">We provide regular updates to reflect latest market trends and regulations</p>
                        </div>
                    </BentoItem>
                    ...
                    <BentoItem className="lg:col-span-2">
                         <div className="pt-6 lg:px-6">
                            {/* SVG Graph */}
                            <svg className="w-full text-gray-300" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="relative z-10 mt-14 space-y-2 text-center">
                            ...
                            <p className="text-gray-600">Get real-time calculations and analysis with lightning-fast performance.</p>
                        </div>
                    </BentoItem>

                    {/* Card 4: Detailed Reports */}
                    <BentoItem className="lg:col-span-3">
                         <div className="grid h-full sm:grid-cols-2">
                            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                {/* MODIFIED SECTION: Icon + Tricolor Text */}
                        ...
                        <div className="grid h-full sm:grid-cols-2">
                            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-gray-600">All tools and guides are created and vetted by certified financial experts.</p>
                                </div>
                            </div>
